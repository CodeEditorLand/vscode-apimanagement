...
export class SubscriptionsTreeItem extends AzureParentTreeItem<IServiceTreeRoot> {
	...
	public static contextValue = "azureApiManagementSubscriptions";
	...
	public async loadMoreChildrenImpl(
		...
		const subscriptionCollection: ApiManagementModels.SubscriptionCollection =
			this._nextLink === undefined
		...
		return this.createTreeItemsWithErrorHandling(
			...
			async (subscription: ApiManagementModels.SubscriptionContract) =>
				new SubscriptionTreeItem(this, subscription),
			(subscription: ApiManagementModels.SubscriptionContract) => {
				if (
					subscription.displayName !== null &&
					subscription.displayName !== undefined
				) {
